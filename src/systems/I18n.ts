...
const TRANSLATIONS: Record<string, { zh: string; en: string }> = {
  ...
  ending_betrayal:      { zh: '背弃故乡',     en: 'Betraying Hometown' },
  ...
  precond_betrayal:      { zh: '隐藏触发：第四章车库 Elias 反悔北上，背弃故土', en: 'Hidden trigger: Ch4 Garage — Elias accepts heading North, betraying the hometown' },
