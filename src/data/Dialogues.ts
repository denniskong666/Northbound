...
// ================================================================
// 第四章隐藏支线｜车库 Elias 反悔对话
// 触发条件：第四章 + 玩家偏向留下（leansStaying() 为 true）
// 不重复第一章对话，提供"我无愧于内心" / "跟你北上绝不后悔"二选一
// 选 B → 触发结局更改：直接锁定 ending = 'betrayal'，跳过屋顶四选一
// ================================================================
export const CH4_GARAGE_ELIAS_DIALOGUE: DialogueData = {
  id: 'ch4_garage_elias_betrayal',
  start: 'ask',
  nodes: {
    ask: {
      speaker: L('伊莱亚斯', 'Elias'),
      text: L('你确定吗？留下来放弃美好的北方生活会是你做过最错误的决定。',
              "Are you sure? Staying here and giving up the beautiful life up North will be the worst mistake you've ever made."),
      choices: [
        {
          label: L('我无愧于内心。', 'I have no regrets in my heart.'),
          next: 'stay',
          effects: { commitment: -2, agency: 2 }
        },
        {
          label: L('……我决定跟你北上，绝不后悔！', "...I've decided to head North with you. No regrets!"),
          next: 'betray',
          effects: {
            commitment: 8,
            agency: -5,
    ...
    // 选项 A：无愧于内心（不改后续，正常推进到屋顶终章四选一）
    stay: {
      speaker: L('伊莱亚斯', 'Elias'),
      text: L('……随你吧。但你别怪我没提醒过你。',
              "...Fine. But don't say I didn't warn you.")
    },
    // 选项 B：反悔北上 → 直接锁定 betrayal 结局
    betray: {
      speaker: L('伊莱亚斯', 'Elias'),
      text: L('……我就知道。走，立刻出发——别让他们看见。',
              "...I knew it. Let's go, right now — don't let them see.")
    }
  }
};
